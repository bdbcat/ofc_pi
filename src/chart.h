...
// ----------------------------------------------------------------------------
// ChartXTR1 Definition
// ----------------------------------------------------------------------------

class  ChartXTR1 : public PlugInChartBase
{
      DECLARE_DYNAMIC_CLASS(ChartXTR1)
...
//    Methods
      ...
      int BSBScanScanline(wxInputStream *pinStream);
      int ReadBSBHdrLine( xtr1_inStream*, char *, int );
